...
* Behörigheter användare kan tilldelas är följande (du skriver ej citattecken eller komman och du kan bara CRUDa en roll i taget per användare): `"get_images","post_images","put_images","delete_images","get_components","post_components","put_components","delete_components"`.
